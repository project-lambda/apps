...
features:
  ...
  - title: Apps
    text: Uninstall apps with the files they leave behind, see what you have not opened in months, and manage what starts at login.
  - title: Optimize
    text: Maintenance tasks that say what they fix and what they touch before they run.
  - title: Analyze
...
faq:
  - q: Does TidyMac delete anything without asking?
    a: No. Every clean shows the full list first, and removed files go to the Trash so you can put them back.
  - q: Which Macs does it support?
    a: macOS 14 Sonoma and later, on Apple Silicon and Intel.
  - q: Is it on the Mac App Store?
    a: No. TidyMac needs access the App Store sandbox does not allow, so it is a direct download.
---
...
One window, five tabs, one purchase. No subscription and no account.
